...
public class Hug extends LocationAction implements Stoppable {


    public Hug(Location location, Person firstPerson, Person secondPerson) {
        super(location,
    ...
    public void stop() throws InterruptedException {
        ...
        firstPerson.stopHugging(secondPerson);
    }
