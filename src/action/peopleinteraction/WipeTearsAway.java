...
public class WipeTearsAway extends LocationAction {


    public WipeTearsAway(Location location, Person firstPerson, Person secondPerson) {
        super(location,
    ...
    protected void actionLogic() throws InterruptedException {
        ...
        firstPerson.wipeTearsAway(secondPerson);
    }
